          ...
          <div className="flex flex-wrap gap-3">
            {counts.warning > 0 && (
              <div className="text-center">
                <div className="text-lg font-bold">⚠️ {counts.warning}</div>
                <div className="text-xs text-blue-100">Warning{counts.warning !== 1 ? 's' : ''}</div>
              </div>
            )}
            {counts.success > 0 && (
              <div className="text-center">
                <div className="text-lg font-bold">✅ {counts.success}</div>
                <div className="text-xs text-blue-100">Win{counts.success !== 1 ? 's' : ''}</div>
              </div>
            )}
            {counts.tip > 0 && (
              <div className="text-center">
                <div className="text-lg font-bold">💡 {counts.tip}</div>
          ...
          {!dashData ? (
            ...
            <div className="rounded-[20px] p-6 bg-white dark:bg-[#141720] border border-gray-200 dark:border-white/[0.06]">
              <div className="space-y-4">
                <div className="w-20 h-20 bg-gray-200 dark:bg-white/5 rounded-2xl animate-pulse mx-auto" />
                <div className="h-6 w-48 bg-gray-200 dark:bg-white/5 rounded animate-pulse mx-auto" />
                <div className="h-4 w-64 bg-gray-200 dark:bg-white/5 rounded animate-pulse mx-auto" />
              </div>
            </div>
          ) : dashData.categories.length === 0 ? (
            // Empty state
            <div className="rounded-[20px] p-6 bg-white dark:bg-[#141720] border border-gray-200 dark:border-white/[0.06]">
              <h3 className="text-base font-semibold text-gray-900 dark:text-white mb-1">Spending Personality</h3>
              <p className="text-xs text-gray-600 dark:text-gray-500 mb-5">Based on your habits</p>
              <p className="text-sm text-gray-500 dark:text-gray-600 text-center py-8">
            ...
            <div className="rounded-[20px] p-6 bg-white dark:bg-[#141720] border border-gray-200 dark:border-white/[0.06]">
              ...
              >
                <span style={{ fontSize: '4rem' }}>{personality.emoji}</span>
              </div>

              {/* Type label */}
              <h4 className="text-xl font-bold text-gray-900 dark:text-white text-center">{personality.type}</h4>

              {/* Description */}
              <p className="text-sm text-gray-600 dark:text-gray-400 text-center mt-2 px-4 leading-relaxed">
                {personality.desc}
              </p>
              ...
              <div className="grid grid-cols-3 gap-4 text-center">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-gray-900 dark:text-white">{dashData.total_count}</p>
